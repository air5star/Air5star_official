...
import { signupSchema } from '../schemas/signupSchema/page';
import { useRouter } from 'next/navigation';
import { signIn } from 'next-auth/react';

type TSignupFormSchema = z.infer<typeof signupSchema>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="text-center">
                <p>
                  ...
                  <Link href="/login" className="text-blue-900 underline px-1">
                    Login
                  </Link>
                  here
                </p>
